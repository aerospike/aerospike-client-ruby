...
module Aerospike
  class Cluster
    attr_reader :connection_timeout, :connection_queue_size, :user, :password, :min_connections_per_node, :features, :tls_options, :cluster_id, :aliases, :cluster_name, :client_policy
