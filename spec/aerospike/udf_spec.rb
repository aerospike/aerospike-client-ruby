  ...
  describe "UDF operations" do
    ...
    describe "register" do
      ...
      it "should register UDFs, list them and and then successfully drop them" do
        ...
        [1, 2, 3].each do |i|
          register_task = client.register_udf(nil, udf_body, "udf#{i}.lua", Aerospike::Language::LUA)
      ...
      it "should execute a udf successfully" do
        ...
        register_task = client.register_udf(nil, udf_body_delete, "udf_delete.lua", Aerospike::Language::LUA)
        ...
        client.put_bins(nil, key1, Aerospike::Bin.new('bin', 'value'))
        client.put_bins(nil, key2, Aerospike::Bin.new('bin', 'value'))
        client.put_bins(nil, key3, Aerospike::Bin.new('bin', 'value'))
